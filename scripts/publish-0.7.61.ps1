# DOUPAO V2 v0.7.61 one-click publish script
...
#   3. Build and publish to GitHub Releases (nideyilian/doupao, tag v0.7.61)
...
gh release edit v0.7.61 --repo nideyilian/doupao --notes-file $bodyFile
if ($LASTEXITCODE -ne 0) {
  Write-Warning "Failed to set release body automatically; please edit the v0.7.61 release body manually on GitHub."
}

Write-Host "[DONE] v0.7.61 published!" -ForegroundColor Green
