...
export const POSTPROCESS_PARAM_FIELDS: PostprocessParamField[] = [
  ...
  },
  {
    ...
    label: '媒体',
    help: '纯净版可单独勾选；勾了任一渠道且开启「纯净版自动伴随」时会自动补一份无水印原图。',
    control: 'media',
    scope: 'both',
    group: 'produce',
    resettable: true,
  },
  {
    key: 'direction',
    label: '画面方向',
    help: '决定每个媒体产出哪些尺寸；跟随尺寸时按原图方向自动匹配。',
    control: 'direction',
    scope: 'both',
    group: 'produce',
    resettable: true,
  },
  {
    key: 'namePattern',
    label: '命名模板',
    help: '产出文件名。留空或缺少占位符会导致同名文件互相覆盖。',
    control: 'namePattern',
    scope: 'both',
    group: 'output',
    resettable: true,
  ...
  },
  {
    key: 'distribution',
    label: '分发',
    help: '整份配置：本级一改，所有分发字段都固化在这里，以后改上层不再影响本节点。',
